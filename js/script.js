...
function initialize() {
    ...
    selectOfficeOption.textContent = "Select Office";
...
function getDataToInitialize(data) {
    ...
    consoleLog(1, "Fetched Data: ", data);

    let enabledList = [basinName, gageName, beginDate, endDate, aveCheckbox, maxCheckbox, minCheckbox, computeHTMLBtn];
    enabledList.map((item) => { item.disabled = false });
